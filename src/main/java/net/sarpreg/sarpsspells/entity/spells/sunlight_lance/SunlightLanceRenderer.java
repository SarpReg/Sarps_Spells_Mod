...
public class SunlightLanceRenderer extends EntityRenderer<SunlightLanceProjectile> {
    private static final ResourceLocation TEXTURE = SarpsSpellsMod.id("textures/entity/sunlight_lance/sunlight_lance.png");

    public SunlightLanceRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(SunlightLanceProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(SunlightLanceProjectile entity) {
        return TEXTURE;
    }
}