package net.sarpreg.sarpsspells.entity.spells.extendedsculktentacle;
...
public class ExtendedVoidTentacle extends VoidTentacle implements GeoEntity, AntiMagicSusceptible {
    ...
    public ExtendedVoidTentacle(EntityType<? extends VoidTentacle> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);

    }

    public ExtendedVoidTentacle(Level level, LivingEntity owner, float damage, int maxAge) {
    ...
    public void tick() {
        if (!level().isClientSide) {
            ...
            if (age == (maxAge - 40) && Utils.random.nextFloat() < .3f) {
...
//    }
    ...
    private PlayState animationPredicate(software.bernie.geckolib.core.animation.AnimationState event) {
        ...
        if (age > (maxAge - 80) && Utils.random.nextFloat() < .04f) {
